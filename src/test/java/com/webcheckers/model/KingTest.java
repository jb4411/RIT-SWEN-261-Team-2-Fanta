...
public class KingTest {
    ...
    public void test_constructor() {
        ...
        CuT = new King(Piece.Color.WHITE);
    ...
    public void test_getCopy() {
        ...
        assertEquals(Piece.Type.KING, copy.getType());
    }
    ...
    public void test_isMoveValid() {
        Move valid = new Move(new Position(4, 1), new Position(5, 0));
        Move invalid = new Move(new Position(6, 6), new Position(9, 9));
    ...
    public void test_isJumpValid() {
        ...
        Move invalidJump = new Move(new Position(5, 0), new Position(8, 2));
    ...
    public void test_hasJump() {
        ...
        // Set up valid jump to the front right of the king piece
        ...
        //Case: there is a jump to the front right of the king piece
        assertTrue(CuT.hasJump(board, 4, 1));


        // Set up valid jump to the front left of the king piece
        ...
        //Case: there is a jump to the front left of the king piece
        assertTrue(CuT.hasJump(board, 4, 3));


        // Set up valid jump to the back right of the king piece
        board = new BoardView(red, white);
        board.makeMove(new Move(new Position(5, 6), new Position(4, 7)));
        board.makeMove((new Move(new Position(5, 4), new Position(4, 3))).inverse());

        //Case: there is a jump to the back right of the king piece
        assertTrue(CuT.hasJump(board, 2, 3));


        // Set up valid jump to the back left of the king piece
        board = new BoardView(red, white);
        board.makeMove(new Move(new Position(5, 6), new Position(4, 7)));
        board.makeMove((new Move(new Position(5, 4), new Position(4, 5))).inverse());
